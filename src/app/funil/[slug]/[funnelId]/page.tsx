...
import { TypebotViewer } from '@/components/editor/TypebotViewer';
    ...
    <>
      <Head>
        ...
        <noscript>
          ...
          src="https://www.facebook.com/tr?id=1973109169841638&ev=PageView&noscript=1"
          />
        </noscript>
        {/* End Meta Pixel Code */}
        ...
        dangerouslySetInnerHTML={{
          __html: `
            function criarBarra() {
              ...
              avatar.innerHTML = '<img src="https://s3.typebot.io/public/workspaces/cm8gbxl5b000ba3ncy4y16grd/typebots/cmi0sldz2000djl043bd6dtvj/blocks/e8vsn1pelzr1o22gyvomkn6l?v=1763544631191" alt="Avatar">';
              var name = document.createElement("div");
              name.className = "name";
              name.innerHTML = '<span>Clickify</span> <span data-testid="psa-verified" data-icon="psa-verified" class=""><svg viewBox="0 0 18 18" height="18" width="18" preserveAspectRatio="xMidYMid meet" class="" version="1.1" x="0px" y="0px" enable-background="new 0 0 18 18" xml:space="preserve"><polygon id="Star-2" fill="#00DA60" points="9,16 7.1,16.9 5.8,15.2 3.7,15.1 3.4,13 1.5,12 2.2,9.9 1.1,8.2 2.6,6.7 2.4,4.6 4.5,4 5.3,2 7.4,2.4 9,1.1 10.7,2.4 12.7,2 13.6,4 15.6,4.6 15.5,6.7 17,8.2 15.9,9.9 16.5,12 14.7,13 14.3,15.1 12.2,15.2 10.9,16.9 "></polygon><polygon id="Check-Icon" fill="#FFFFFF" points="13.1,7.3 12.2,6.5 8.1,10.6 5.9,8.5 5,9.4 8,12.4 "></polygon></svg></span><span class="status">Online</span>';
            ...
            function applyCustomStyles() {
                ...
                styleElement.textContent = \`
                    .typebot-host-bubble { padding-right: 12px; }
                    #checkIcon { stroke-dasharray: 40; stroke-dashoffset: 40; z-index: 99; }
                    ...
                    .typebot-chat-view > .flex:first-child { padding-top: 30px; }
                    .typebot-input { position: fixed; bottom: 0; align-items: center; z-index: 999; right: 0; }
                    .typebot-input .typebot-button { background: #2a3942; border-radius: 50%; color: #2a3942; position: relative; width: 50px; height: 50px; display: flex; align-items: center; justify-content: center; }
                    .typebot-container { background-size: initial!important; background-repeat: repeat-x!important; }
                    .typebot-host-bubble>.bubble-typing { border-radius: 0 5px 5px 5px; }
                    .typebot-host-bubble>.bubble-typing:after { position: absolute; content: ""; width: 0; height: 0; border-style: solid; border-width: 0px 10px 10px 0; border-color: transparent #202c33 transparent transparent; top: 0; left: -10px; }
                    .typebot-guest-bubble { position: relative; border-radius: 5px 0 5px 5px; }
                    .typebot-guest-bubble:after { position: absolute; content: ""; width: 0; height: 0; border-style: solid; }
                    .typebot-guest-bubble:after { border-width: 0px 0 10px 10px; border-color: transparent transparent transparent #114D34; top: 0; right: -10px; border-style: solid; }
                    ...
                    .info-container { font-size: 14px; }
                    .typebot-input .typebot-button { content: ""; background: #21c063; border-radius: 50%; position: relative; display: flex; align-items: center; justify-content: center; width: 50px; height: 50px; border: none; font-size: 0px; color: transparent; }
                    .typebot-input .typebot-button::before { content: ""; position: absolute; top: 50%; transform: translateY(-50%); width: 25px; height: 25px; background-repeat: no-repeat; background-size: cover; background-image: url('data:image/svg+xml;charset=utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="19px"><path d="M476.59 227.05l-.16-.07L49.35 49.84A23.56 23.56 0 0027.14 52 24.65 24.65 0 0016 72.59v113.29a24 24 0 0019.52 23.57l232.93 43.07a4 4 0 010 7.86L35.53 303.45A24 24 0 0016 327v113.31A23.57 23.57 0 0026.59 460a23.94 23.94 0 0013.22 4 24.55 24.55 0 009.52-1.93L476.4 285.94l.19-.09a32 32 0 000-58.8z" fill="black"/></svg>'); }
                    .typebot-input .typebot-button .send-icon { display: none; }
                    .typebot-input { max-width: 100%!important; width:100%!important; position: fixed; bottom: 50px; align-items: center; z-index: 999; right: 0; margin-bottom: 20px; background-color: #2a3942; border-radius: 50px; box-shadow: 1 2px 1px -1px rgba(0,0,0,.2); height: 50px; padding-right: 0px!important; }
                    .disabled\\\\:opacity-50:disabled { opacity: 1; }
                    @media (max-width: 500px) { .info-container { max-width: 400px !important; } }
                \`;
            ...
            function main() {
                ...
                if (!typebotStandard || !typebotStandard.shadowRoot) {
                    setTimeout(main, 100);
                    return;
                }
                criarBarra();
                applyCustomStyles();
                const botBody = typebotStandard.shadowRoot.querySelector('.typebot-container');
                if (!botBody) {
                    setTimeout(main, 100);
                    return;
                }
                ...
                createInfoMessage(botBody);
                function createInfoMessage(botBody) {
